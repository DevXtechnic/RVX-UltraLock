...
public class BaseSettings {
    ...
    public static final BooleanSetting DISABLE_AUTO_CAPTIONS = new BooleanSetting("revanced_disable_auto_captions", TRUE, true);
    ...
    public static final BooleanSetting BYPASS_IMAGE_REGION_RESTRICTIONS = new BooleanSetting("revanced_bypass_image_region_restrictions", TRUE, true);
    ...
    public static final BooleanSetting ULTRA_LOCK_ENABLED = new BooleanSetting("revanced_ultra_lock_enabled", FALSE, true);
}
